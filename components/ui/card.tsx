...
function Card({
  ...
  return (
    <div
      data-slot="card"
      data-size={size}
      // customized: DESIGN.md depth-by-surface (US-048) — rounded-lg + hairline
      // border-border instead of rounded-xl + resting shadow-xs/ring (depth is
      // surface ladder + 1px hairline, not drop shadow; §95/§273).
      className={cn(
