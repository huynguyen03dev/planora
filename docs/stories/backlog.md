...
| E08-personal-productivity-and-capture | Today/My Work cross-board view, global quick capture, and per-board triage lists | planned |
...
| US-078 | Global quick capture using standard Card creation | E08-personal-productivity-and-capture | normal | planned (unstarted) |
