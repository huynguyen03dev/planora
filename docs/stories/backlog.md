...
| E08-personal-productivity-and-capture | Today/My Work cross-board view, global quick capture, and per-board triage lists | planned (US-083 in progress) |
...
| US-083 | Demo-ready daily work loop (W1–W8: realtime proof, live invite badge, demo determinism, retention/tracker reconciliation, Today/My Work, quick capture, bounded undo) | E08-personal-productivity-and-capture | high-risk | in progress (Stage 1 W1–W5 landed 2026-08-02 — W4/W5 uncommitted on the feature branch; Stage 2 W6–W8 pending) |
