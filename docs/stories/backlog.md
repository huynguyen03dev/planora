...
| E08-personal-productivity-and-capture | Today/My Work cross-board view, global quick capture, and per-board triage lists | active (US-083 implemented — merged via PR #94 on 2026-08-02; US-079 per-board triage still planned) |
