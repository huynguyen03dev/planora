...
| E08-personal-productivity-and-capture | Today/My Work cross-board view, global quick capture, and per-board triage lists | planned (US-083 planned) |
...
| US-083 | Demo-ready daily work loop (W1–W8: realtime proof, live invite badge, demo determinism, retention/tracker reconciliation, Today/My Work, quick capture, bounded undo) | E08-personal-productivity-and-capture | high-risk | planned (unstarted) |
